      ...
      <button
        ...
        className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold border transition-all ${
          isOpen || isActive
            ...
            : 'bg-white text-[#191929] border-[#191929]/20 hover:border-[#1918f0]/50'
        }`}
      >
              ...
              <button
                ...
                className={`w-full text-left px-5 py-3 text-sm font-bold transition-colors ${
                  selected === option
                    ...
                    : 'text-[#191929]/60 hover:bg-gray-50 hover:text-[#1918f0]'
                }`}
              >
                {option}
              </button>
  ...
  return (
    <div className="min-h-screen bg-[#f9f7f2] py-12 px-4 font-['Inter Tight']">
      <div className="max-w-4xl mx-auto space-y-8 h-full flex flex-col">
        ...
        <div className="bg-white border-2 border-[#191929]/10 rounded-[32px] p-8 shadow-2xl flex-1 flex flex-col min-h-[600px] overflow-hidden">
          {!isActive ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-2xl font-bold text-[#191929]">Ready for your interview?</h3>
                <p className="text-[#191929]/60">Start a voice conversation with our expert AI interviewer.</p>
              </div>
              <button 
            ...
            <>
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-[#191929]">AI Mock Interview</h3>
              ...
              <div className="flex-1 overflow-y-auto space-y-6 mb-8 pr-2 no-scrollbar">
                {transcripts.map((t, i) => (
                  <div key={i} className={`flex ${t.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                    <div className={`max-w-[85%] p-4 rounded-2xl ${t.role === 'user' ? 'bg-[#1918f0]/5 text-[#191929] border border-[#1918f0]/20' : 'bg-gray-50 text-[#191929] border border-gray-100'}`}>
                ...
                {(currentAiText || currentUserText) && (
                  <div className={`flex ${currentUserText ? 'justify-end' : 'justify-start'} animate-pulse`}>
                    <div className={`max-w-[85%] p-4 rounded-2xl ${currentUserText ? 'bg-[#1918f0]/5 text-[#191929] border border-[#1918f0]/20' : 'bg-gray-50 text-[#191929] border border-gray-100'}`}>
              ...
              <div className="p-6 bg-[#f9f7f2] rounded-2xl text-center space-y-4">
                ...
                <p className="text-sm font-bold text-[#191929]">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
          <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-xl shadow-gray-200/20 flex flex-col min-h-[400px]">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-[#191929] leading-[1.3] flex-1">
              {current.question}
            </h2>
          ...
          <div className="bg-white rounded-3xl border border-gray-100 p-10 flex flex-col shadow-xl shadow-gray-200/20 min-h-[400px]">
            ...
            <p className="text-xl font-medium text-[#191929] leading-[1.6] whitespace-pre-wrap flex-1">
        ...
        <div className="flex items-center justify-between pt-8 px-4">
          ...
          <div className="text-sm font-medium text-[#191929]/40">
...
const InterviewPrep: React.FC = () => {
  ...
  return (
    <div className="bg-white font-['Inter Tight'] min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div className="space-y-4">
              <h1 className="text-4xl lg:text-5xl font-semibold text-[#191929] leading-[1.15] tracking-[-0.04em]">Interview Library</h1>
              <p className="text-[#191929]/60 max-w-lg">Master the most frequent interview questions with expert answers and structured study tools.</p>
            </div>
            <button 
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredQuestions.map((q, index) => (
            ...
            >
              <h3 className="text-xl font-bold text-[#191929] mb-8 leading-[1.4] flex-1">
                {q.question}
              </h3>
              ...
              <div className="flex flex-wrap items-center gap-4 border-t border-gray-50 pt-6">
                ...
                <div className="ml-auto flex items-center gap-4">
                   <div className="flex items-center gap-2 text-sm font-bold text-[#191929] group-hover:text-[#1918f0] transition-colors">
        ...
        {filteredQuestions.length === 0 && (
          <div className="text-center py-20 space-y-4">
            ...
            <h3 className="text-xl font-bold text-[#191929]">No questions found</h3>
            <p className="text-[#191929]/40">Try adjusting your filters to find what you're looking for.</p>
            <button 
      ...
      <section className="bg-[#191929] py-24 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
           ...
           <div className="flex flex-wrap justify-center gap-4 pt-4">
             <button className="bg-white text-[#191929] px-10 py-4 rounded-full font-bold shadow-2xl transition-all hover:bg-gray-100">App Store</button>
